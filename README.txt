...
2. Or click the small • at the bottom of the website

Password: ramnad123

What you can do:
- Change product price, name, description
- Add new product
- Delete product
- Download updated all.json (then replace in data/ folder)

Note:
- Changes are saved in browser (localStorage)
- To make permanent, download all.json and replace the file in data/ folder
- For new photos: put the image file in images/ folder first, then use path like images/myphoto.jpg
